// Framing: anatomy education + scan visualization. AI explains concepts; the user
// or clinician interprets their scan. No diagnostic claims.
...
export function buildUserMessage({ regionLabel, pathologyName, hasUpload, uploadContext }) {
  const lines = [
    `Region: ${regionLabel}`,
